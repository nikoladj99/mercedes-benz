      ...
      {photos.map((slide, index) => {
        return (
          <div
            className={
              index === photoPtr
                ? "bg-no-repeat w-full h-full xl:bg-cover sm:bg-contain bg-cover xl:mt-32 mt-24 slide active "
                : "slide"
            }
          ...
          >
            <div className="text-4xl tbx">
              ...
              <button className="btnDis xl:visible invisible">
                Discover now
              </button>
            </div>
            <div class="flex items-center justify-between arrs">
              <svg
                ...
                onClick={() => {
                  setPhotoPtr(
                    photoPtr - 1 == 0 ? photos.length - 1 : photoPtr - 1
                  );
                }}
              >
                <path
